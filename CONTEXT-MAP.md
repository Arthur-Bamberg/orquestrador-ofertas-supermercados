...
- [Catálogo de ofertas](./apps/ofertas-scraper/CONTEXT.md) — Oferta, Produto, Mercado, Fonte, Documento, Coleta, Extrator, Indicação Promocional (encarte, web scraper, API e backoffice)
...
- **Catálogo → Agente**: o Agente lê Oferta (e o catálogo); não escreve o catálogo nem chama o Extrator nem a Coleta.
- **Encarte e Coleta**: dois caminhos de escrita no mesmo catálogo; Fonte/Documento não servem ao site; Coleta não substitui o Extrator.
